...
obterBrasil = () => {
	getJSON('assets/php/XmlToJson.php?opcao=brasil');
}

obterMundo = () => {
	getJSON('assets/php/XmlToJson.php?opcao=mundo');
}

obterCultura = () => {
	getJSON('assets/php/XmlToJson.php?opcao=cultura');
}

obterEducacaoProfissional = () => {
	getJSON('assets/php/XmlToJson.php?opcao=educacao_profissional');
}

obterEnsinoSuperior = () => {
	getJSON('assets/php/XmlToJson.php?opcao=ensino_superior');
}

obterPosGraduacao = () => {
	getJSON('assets/php/XmlToJson.php?opcao=pos_graduacao');
}
...
obterTurismo = () => {
	getJSON('assets/php/XmlToJson.php?opcao=turismo');
}
